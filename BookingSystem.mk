...
WorkspacePath          :=/home/jerry/Documents/CodeLite
ProjectPath            :=/home/jerry/Documents/CodeLite
...
Objects0=./build-$(ConfigurationName)//src_LoginPage.cpp$(ObjectSuffix) ./build-$(ConfigurationName)//src_StudentPage.cpp$(ObjectSuffix) ./build-$(ConfigurationName)//src_Report.cpp$(ObjectSuffix) ./build-$(ConfigurationName)//src_User.cpp$(ObjectSuffix) ./build-$(ConfigurationName)//src_Appointment.cpp$(ObjectSuffix) ./build-$(ConfigurationName)//src_Global.cpp$(ObjectSuffix) ./build-$(ConfigurationName)//src_Rooms.cpp$(ObjectSuffix) ./build-$(ConfigurationName)//main.cpp$(ObjectSuffix) ./build-$(ConfigurationName)//src_Windows.cpp$(ObjectSuffix) ./build-$(ConfigurationName)//src_UserPage.cpp$(ObjectSuffix) \
...
./build-$(ConfigurationName)//src_LoginPage.cpp$(ObjectSuffix): src/LoginPage.cpp ./build-$(ConfigurationName)//src_LoginPage.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/jerry/Documents/CodeLite/src/LoginPage.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_LoginPage.cpp$(ObjectSuffix) $(IncludePath)
...
./build-$(ConfigurationName)//src_StudentPage.cpp$(ObjectSuffix): src/StudentPage.cpp ./build-$(ConfigurationName)//src_StudentPage.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/jerry/Documents/CodeLite/src/StudentPage.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_StudentPage.cpp$(ObjectSuffix) $(IncludePath)
...
./build-$(ConfigurationName)//src_Report.cpp$(ObjectSuffix): src/Report.cpp ./build-$(ConfigurationName)//src_Report.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/jerry/Documents/CodeLite/src/Report.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_Report.cpp$(ObjectSuffix) $(IncludePath)
...
./build-$(ConfigurationName)//src_User.cpp$(ObjectSuffix): src/User.cpp ./build-$(ConfigurationName)//src_User.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/jerry/Documents/CodeLite/src/User.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_User.cpp$(ObjectSuffix) $(IncludePath)
...
./build-$(ConfigurationName)//src_Appointment.cpp$(ObjectSuffix): src/Appointment.cpp ./build-$(ConfigurationName)//src_Appointment.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/jerry/Documents/CodeLite/src/Appointment.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_Appointment.cpp$(ObjectSuffix) $(IncludePath)
...
./build-$(ConfigurationName)//src_Global.cpp$(ObjectSuffix): src/Global.cpp ./build-$(ConfigurationName)//src_Global.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/jerry/Documents/CodeLite/src/Global.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_Global.cpp$(ObjectSuffix) $(IncludePath)
...
./build-$(ConfigurationName)//src_Rooms.cpp$(ObjectSuffix): src/Rooms.cpp ./build-$(ConfigurationName)//src_Rooms.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/jerry/Documents/CodeLite/src/Rooms.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_Rooms.cpp$(ObjectSuffix) $(IncludePath)
...
./build-$(ConfigurationName)//main.cpp$(ObjectSuffix): main.cpp ./build-$(ConfigurationName)//main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/jerry/Documents/CodeLite/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
...
./build-$(ConfigurationName)//src_Windows.cpp$(ObjectSuffix): src/Windows.cpp ./build-$(ConfigurationName)//src_Windows.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/jerry/Documents/CodeLite/src/Windows.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_Windows.cpp$(ObjectSuffix) $(IncludePath)
...
./build-$(ConfigurationName)//src_UserPage.cpp$(ObjectSuffix): src/UserPage.cpp ./build-$(ConfigurationName)//src_UserPage.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/jerry/Documents/CodeLite/src/UserPage.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_UserPage.cpp$(ObjectSuffix) $(IncludePath)
